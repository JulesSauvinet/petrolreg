...
\newline
Les courbes des puits '$Well-288$' de good à médium, '$Well-333$' de bad à médium,
'$Well-246$' de médium à bad, '$Well-257$' de good à médium, et '$Well-258$' de bad à médium.
...
\begin{figure}[H]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
	\includegraphics[width=500px]{smooth_clustering_exp}
  \caption{\label{fig:reg_exp_smooth_loess} Clustering sur modèle exponentiel avec courbes liss\'ee}
\end{figure}
